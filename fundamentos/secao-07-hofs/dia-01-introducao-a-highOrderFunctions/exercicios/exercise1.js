...
function everyoneWasBornOnSecXX() {
    return books.every((person) => person.author.birthYear >= 1901 && person.author.birthYear <= 2000 );
}
...
//Faça uma função que retorne true se dois autores nasceram em anos diferentes
//e false caso dois autores tenham nascido no mesmo ano
...
const authorUnique = () => {
    ...
    !books.some((autorSome) => 
    (autorSome.author.birthYear === autor.author.birthYear)
    && (autorSome.author.name !== autor.author.name)));
};
